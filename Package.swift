...
let package = Package(
    ...
    targets: [
        .binaryTarget(
            ...
            url: "https://github.com/proximiio/proximiio-sdk-ios-binary/releases/download/6.0.0-beta.35/ProximiioBinary.xcframework.zip",
            checksum: "7b7c29e5be5672e06d6b16076d71aa6adc775d8496ec160cf3808f1ee53f352f"
        ),
        .target(
            name: "Proximiio",
