...
let package = Package(
    ...
    targets: [
        .binaryTarget(
            ...
            url: "https://github.com/proximiio/proximiio-sdk-ios-binary/releases/download/6.0.0-beta.44/ProximiioBinary.xcframework.zip",
            checksum: "a2ace817cef401569a5bb00a676c3dc0ef44bf2c4eb543eb623fe57c941f98e1"
        ),
        .target(
            name: "Proximiio",
