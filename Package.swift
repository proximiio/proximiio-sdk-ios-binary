...
let package = Package(
    ...
    targets: [
        .binaryTarget(
            ...
            url: "https://github.com/proximiio/proximiio-sdk-ios-binary/releases/download/6.0.0-beta.40/ProximiioBinary.xcframework.zip",
            checksum: "2de6aa1040c665bc795b9c447a9a6701f573bbb957f51a503ba609de8352bc0c"
        ),
        .target(
            name: "Proximiio",
