...
let package = Package(
    ...
    targets: [
        .binaryTarget(
            ...
            url: "https://github.com/proximiio/proximiio-sdk-ios-binary/releases/download/6.0.0-beta.36/ProximiioBinary.xcframework.zip",
            checksum: "e389e93d175643013ae542e03deb10c69c6e9a74d42ebd52472822c1ebb4f371"
        ),
        .target(
            name: "Proximiio",
