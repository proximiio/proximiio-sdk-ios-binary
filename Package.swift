...
let package = Package(
    ...
    targets: [
        .binaryTarget(
            ...
            url: "https://github.com/proximiio/proximiio-sdk-ios-binary/releases/download/6.0.0-beta.38/ProximiioBinary.xcframework.zip",
            checksum: "b73106ccc0d8695e739a5d1e22b1e8ae47a1363ca6729ad0908af23ca08dca69"
        ),
        .target(
            name: "Proximiio",
