...
let package = Package(
    ...
    targets: [
        .binaryTarget(
            ...
            url: "https://github.com/proximiio/proximiio-sdk-ios-binary/releases/download/6.0.0-beta.39/ProximiioBinary.xcframework.zip",
            checksum: "357d4fbedcaf0730722c18b82f60460fe331a1a4eb646071f310c8cdbec90a31"
        ),
        .target(
            name: "Proximiio",
