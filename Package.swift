...
let package = Package(
    ...
    targets: [
        .binaryTarget(
            ...
            url: "https://github.com/proximiio/proximiio-sdk-ios-binary/releases/download/6.0.0-beta.41/ProximiioBinary.xcframework.zip",
            checksum: "64a5f99e693afd27aacf6aa05f8ef6c145fb111155c1456d29dfa873a4e19446"
        ),
        .target(
            name: "Proximiio",
