...
let package = Package(
    ...
    targets: [
        .binaryTarget(
            ...
            url: "https://github.com/proximiio/proximiio-sdk-ios-binary/releases/download/6.0.0-beta.37/ProximiioBinary.xcframework.zip",
            checksum: "9811269c72384c7b45f85da7ce77b4ff64faf7becabcec12054ab805ce150a50"
        ),
        .target(
            name: "Proximiio",
